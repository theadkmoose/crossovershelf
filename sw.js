...
const CACHE_VERSION = "v38-king-insights-fixed";
...
const SHELL_CONTROLS = "./shell-controls-v26.js?v=35";
...
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls-v26.js","./king-insights-v2.js","./stats-enhancement-init.js","./rank-movement.js","./rfantasy-modal-fix-v8.js","./rfantasy-2025-10plus.csv","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
