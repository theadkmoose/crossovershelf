...
const CACHE_VERSION = "v36-king-insights";
...
const KING_INSIGHTS = "./king-insights.js?v=36";
...
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls-v26.js","./king-insights.js","./stats-enhancement-init.js","./rank-movement.js","./rfantasy-modal-fix-v8.js","./rfantasy-2025-10plus.csv","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
