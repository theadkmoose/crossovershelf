// Crossover Shelf — experimental r/Fantasy page-scoped adapter
const CACHE_VERSION = "v26-rfantasy-safe";
...
const RF_ADAPTER = "./rfantasy-page-adapter.js?v=1";
const RF_SMOKE = "./rfantasy-page-adapter-test.js?v=1";
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls.js","./stats-enhancement-init.js","./rank-movement.js","./rfantasy-page-adapter.js","./rfantasy-page-adapter-test.js","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
