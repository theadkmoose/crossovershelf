...
const CACHE_VERSION = "v27-add-book-ai";
...
const RANK_MOVEMENT = "./rank-movement.js?v=25";
const UI_ENHANCEMENTS = "./ui-enhancements-v1.js?v=1";
const ADD_BOOK_AI = "./add-book-ai.js?v=1";
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls.js","./stats-enhancement-init.js","./rank-movement.js","./ui-enhancements-v1.js","./add-book-ai.js","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
