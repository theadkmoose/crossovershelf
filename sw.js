...
const CACHE_VERSION = "v32-rfantasy-modal";
...
const SHELL_CONTROLS = "./shell-controls.js?v=24";
const STATS_INIT = "./stats-enhancement-init.js?v=24";
const RANK_MOVEMENT = "./rank-movement.js?v=26";
const RF_MODAL = "./rfantasy-modal-fix-v6.js?v=32";
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls.js","./stats-enhancement-init.js","./rank-movement.js","./rfantasy-modal-fix-v6.js","./rfantasy-2025-10plus.csv","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
