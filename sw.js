...
const CACHE_VERSION = "v31-rfantasy-modal";
...
const RF_MODAL = "./rfantasy-modal-fix-v5.js?v=31";
const CORE_ASSETS = ["./","./index.html","./my-reading.js","./ai-recommendations.js","./shell-controls.js","./stats-enhancement-init.js","./rank-movement.js","./rfantasy-modal-fix-v5.js","./rfantasy-2025-10plus.csv","./manifest.webmanifest","./icon-180.png","./icon-192.png","./icon-512.png"];
