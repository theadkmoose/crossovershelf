(()=>{
"use strict";
const FLAG="__RFantasyModalPresentationV4";
if(window[FLAG])return;window[FLAG]=true;
function findRFModal(){
  return [...document.querySelectorAll(".modal")].find(el=>{
    const t=(el.textContent||"").replace(/\s+/g," ");
    return /r\/Fantasy 2025/i.test(t)&&/Reading Status/i.test(t)&&/Your Notes/i.test(t);
  })||null;
}
function fix(){
