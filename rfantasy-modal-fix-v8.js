(()=>{
"use strict";
const FLAG="__RFantasyModalPresentationV8";
...
function rewrite(modal,rank,votes){
  ...
  // Keep Synopsis visible for every book. The underlying BOOKS data already
  // supplies b.synopsis and the main modal renderer writes it to #m-synopsis.
